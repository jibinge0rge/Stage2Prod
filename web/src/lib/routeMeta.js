export const ROUTES = [
  ...
  { path: '/settings', navKey: 'settings', title: 'Rules & polling', subtitle: 'Map Open → In progress → In QA → Ready for release → Done to your Jira statuses', icon: 'navbar-remediation.svg', label: 'Rules & polling', group: 'configure' },
